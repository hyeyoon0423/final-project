...
2. Plot
```{python}
# Load the dataset (verify the file path)
merged_data_path = '/Users/hyeyoonsmacbook/Desktop/Github/final-project/data/merged_data.csv'
merged_data = pd.read_csv(merged_data_path)

# Disable Altair's row limit for visualization
alt.data_transformers.disable_max_rows()

# Scatter Plot: Relationship between firm profitability and emissions
scatter_plot = alt.Chart(merged_data).mark_circle(size=60).encode(
    ...
    title="Profit vs. Scope 1 Emissions (2020)",
    width=600,
    height=400
)

# Bar Chart: Comparing emission efficiency by industry
bar_chart = alt.Chart(merged_data).mark_bar().encode(
    ...
    title="Total Scope 1 Emissions by Industry (2020)",
    width=600,
    height=400
)
